...
*   obj.parsedParentHost,       -> parsing host to "http://www.google.com" format
*   obj.parsedMainHost,   -> parsing mainHost to "http://www.google.com" format
*   obj.sameAsHost,       -> parsedUrl and parsedParentHost share same url (like http://www.google.com) (boolean)
...
*   var u = new URL("www.google.com/about", "www.google.com", "www.google.com") =>  u.parsedUrl = 'http://www.google.com/about'; 
                                                                                    ...
                                                                                    u.isValid = true;
                                                                                    u.originalUrl = "www.google.com/about";
                                                                                    u.originalParentHost = "www.google.com";
                                                                                    u.originalMainHostUrl = "www.google.com/about";
                                                                                    u.urlIsInteral = false;
                                                                                    u.sameAsHost = true;
                                                                                    u.sameAsMainHost = true;
...
*   var u = new URL("hfghfgh", "dgdfgdfg", "sdfsdf")          =>    u.parsedUrl = undefined ;
                                                                    u.parsedParentHost = undefined ;
                                                                    u.parsedMainHost = undefined
                                                                    u.isValid = false;
                                                                    u.originalUrl = "hfghfgh";
                                                                    u.originalParentHost = "sdfsdf"
...
var URL = function(url, mainHost, host){
  ...
  this.parsedParentHost =  (host) ? _parseUrl(host, false) : _getHost( _parseUrl(url, false)) ;   //add host or create it from url
  this.parsedUrl = this.urlIsInteral ? _parseUrl(url, true, this.parsedParentHost) : _parseUrl(url, false);
  this.parsedMainHost = _getHost( _parseUrl(mainHost, false ));
  this.sameAsHost = (_getHost(this.parsedUrl) === _getHost(this.parsedParentHost));         // if address and parsedParentHost share same host as parsedUrl (www.google.com)
...
function _parseUrl(url, isInternal, host){
  ...
  if (url.slice(0,8) === 'https://') return url;              //TODO: add regex to cpmpare all http://  ftp:// ...
